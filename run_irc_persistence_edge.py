"""
run_irc_persistence_edge.py — IRC Persistence Edge

Spusteni:
    conda activate market_research_lab
    cd C:\\Users\\stava\\Projects\\MarketResearchLab
    python run_irc_persistence_edge.py
"""
...
from experiments.edge_validation.irc_persistence_edge_v1 import IRCPersistenceEdge_v1
...
config = ExperimentConfig(
    ...
    parameters = {},
    notes      = "RP-0006: IRC Persistence Edge (industry-level, bez MLE)",
)
...
logger.info("=== IRC Persistence Edge (RP-0006) ===")
result = runner.run(experiment=IRCPersistenceEdge_v1(), config=config)
