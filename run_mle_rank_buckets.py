"""
run_mle_rank_buckets.py — MLE Rank Buckets kompletni profil

Spusteni:
    conda activate market_research_lab
    cd C:\\Users\\stava\\Projects\\MarketResearchLab
    python run_mle_rank_buckets.py
"""
...
from experiments.edge_validation.mle_rank_buckets_v1 import MLERankBuckets_v1
...
config = ExperimentConfig(
    ...
    parameters = {},
    notes      = "RP-0007: MLE Rank Buckets kompletni profil 1-150",
)
...
logger.info("=== MLE Rank Buckets (RP-0007) ===")
result = runner.run(experiment=MLERankBuckets_v1(), config=config)
