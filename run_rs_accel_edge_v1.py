"""
run_rs_accel_edge_v1.py — RP-0010-FEATURE-VOLUME (F002)

Druhý Feature Validation experiment: RS Acceleration (5D-20D) vs 20D fwd (spojitý).
...
Spuštění:
    ...
    python run_rs_accel_edge_v1.py
"""
...
from experiments.feature_validation.rs_accel_edge_v1 import RSAccelEdge_v1
...
config = ExperimentConfig(
    ...
    parameters = {},
    notes      = "RP-0010: RS Acceleration Edge (F002, 5D-20D, spojitý target)",
)
...
logger.info("=== RS Acceleration Edge (RP-0010, F002) ===")
result = runner.run(experiment=RSAccelEdge_v1(), config=config)
