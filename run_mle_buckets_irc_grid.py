"""
run_mle_buckets_irc_grid.py — MLE Rank Buckets x IRC Tailwind

Spusteni:
    conda activate market_research_lab
    cd C:\\Users\\stava\\Projects\\MarketResearchLab
    python run_mle_buckets_irc_grid.py
"""
...
from experiments.edge_validation.mle_buckets_irc_grid_v1 import MLEBucketsIRCGrid_v1
...
config = ExperimentConfig(
    ...
    parameters = {},
    notes      = "RP-0008: MLE Rank Buckets x IRC Tailwind",
)
...
logger.info("=== MLE Rank Buckets x IRC (RP-0008) ===")
result = runner.run(experiment=MLEBucketsIRCGrid_v1(), config=config)
