"""
run_mle_irc_rolling_validation.py — MLE x IRC Rolling Validation

Spusteni:
    conda activate market_research_lab
    cd C:\\Users\\stava\\Projects\\MarketResearchLab
    python run_mle_irc_rolling_validation.py
"""
...
from experiments.edge_validation.mle_irc_rolling_validation_v1 import MLEIRCRollingValidation_v1
...
config = ExperimentConfig(
    ...
    parameters = {},
    notes      = "RP-0005: MLE x IRC Rolling Validation",
)
...
logger.info("=== MLE x IRC Rolling Validation (RP-0005) ===")
result = runner.run(experiment=MLEIRCRollingValidation_v1(), config=config)
