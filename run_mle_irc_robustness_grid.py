"""
run_mle_irc_robustness_grid.py — MLE x IRC Robustness Grid

Spusteni:
    conda activate market_research_lab
    cd C:\\Users\\stava\\Projects\\MarketResearchLab
    python run_mle_irc_robustness_grid.py
"""
...
from experiments.edge_validation.mle_irc_robustness_grid_v1 import MLEIRCRobustnessGrid_v1
...
config = ExperimentConfig(
    ...
    parameters = {},
    notes      = "RP-0004: MLE x IRC Robustness Grid",
)
...
logger.info("=== MLE x IRC Robustness Grid (RP-0004) ===")
result = runner.run(experiment=MLEIRCRobustnessGrid_v1(), config=config)
