"""
run_mle_ims_interaction.py — MLE x IMS Signal Interaction

Spusteni:
    conda activate market_research_lab
    cd C:\\Users\\stava\\Projects\\MarketResearchLab
    python run_mle_ims_interaction.py
"""
...
from experiments.edge_validation.mle_ims_interaction_v1 import MLEIMSInteraction_v1
...
# SPY neni v sp500_rank_calendar universe — nacteme separatne
...
config = ExperimentConfig(
    ...
    parameters = {},
    notes      = "RP-0002: MLE x IMS Signal Interaction",
)
...
logger.info("=== MLE x IMS Signal Interaction (RP-0002) ===")
result = runner.run(experiment=MLEIMSInteraction_v1(), config=config)
