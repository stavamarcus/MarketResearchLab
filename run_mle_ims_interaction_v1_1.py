"""
run_mle_ims_interaction_v1_1.py — MLE x IMS Interaction v1.1.0

IMS jako prioritizace UVNITR MLE TOP20 (ne prekryv nezavislych mnozin).

Spusteni:
    conda activate market_research_lab
    cd C:\\Users\\stava\\Projects\\MarketResearchLab
    python run_mle_ims_interaction_v1_1.py
"""
...
from experiments.edge_validation.mle_ims_interaction_v1_1 import MLEIMSInteraction_v1_1
...
config = ExperimentConfig(
    ...
    parameters = {},
    notes      = "RP-0003: IMS prioritization within MLE TOP20",
)
...
logger.info("=== MLE x IMS Interaction v1.1.0 (RP-0003) ===")
result = runner.run(experiment=MLEIMSInteraction_v1_1(), config=config)
